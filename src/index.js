 ...
 * @returns {HTMLElement[]} list of the matched input elements
 */
 ...
 * @param   {import('riot').RiotComponentWrapper} componentAPI - component shell object
 * @param   {object} props - initial props
 * @returns {*} output generated by the renderer function
 */
export function createRenderer(renderer, tagName, componentAPI, props = {}) {
  dom.create()
 ...
 * Get only the html string from a renderer function
 * @param   {object} options - function params as object
 * @param   {Function} options.getCSS - function getting the component css
 * @param   {Function} options.getHTML - function getting the component html
 * @param   {Function} options.dispose - teardown function
 * @param   {boolean} isAsync - true if the rendering was handled asynchronously
